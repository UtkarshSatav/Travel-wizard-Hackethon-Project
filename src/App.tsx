...
function App() {
  ...
  return (
    <Background>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 z-10">
        {/* Header */}
        ...
        {/* Footer */}
        <footer className="relative bottom-0 w-full mt-20 bg-white text-gray-900 border-t border-gray-200">
